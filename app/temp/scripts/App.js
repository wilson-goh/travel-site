...
class RevealOnScroll {
  ...
  useWaypointsForScrolling() {
    ...
    this.itemsToReveal.each(function () {
      //  var thisDomElement = this ;        // console.log(this);
      new Waypoint({
        element: this, //DomElement ,
        handler: () => {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this) //$(thisDomElement) // .removeClass("reveal-item")
...
/* harmony import */ var _node_modules_waypoints_lib_noframework_waypoints_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _node_modules_waypoints_lib_noframework_waypoints_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_waypoints_lib_noframework_waypoints_js__WEBPACK_IMPORTED_MODULE_2__);
...
class StickyHeader {
  ...
  useWaypointsForFixHeader() {
    ...
    new Waypoint({
      ...
      handler: upOrDown => {
        if (upOrDown == "down") that.siteHeader.addClass(str);else that.siteHeader.removeClass(str);
      }
      //,  offset : that.offset
    });
  }
      ...
      new Waypoint({
        ...
        handler: direction => {
          if (direction == "down") {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(matchedLink).addClass("is-current-link");
          }
        },
        offset: "25%"
      });
